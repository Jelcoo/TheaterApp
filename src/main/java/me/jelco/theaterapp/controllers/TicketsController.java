...
public class TicketsController implements Initializable {    User loggedInUser;
    Database database;
    Stage stage;
    Scene scene;

    public TicketsController(User user, Database database, Stage stage) throws IOException {
    ...
    public void show() {
        stage.setTitle("Theater Manager - Tickets");
